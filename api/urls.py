...
urlpatterns = [
    ...
    path('tube/large-videos/like/<int:video_id>', views.LargeVideoLikeAPI.as_view()),
    path('tube/large-videos/comment/<int:video_id>', views.LargeVideoCommentAPI.as_view()),
